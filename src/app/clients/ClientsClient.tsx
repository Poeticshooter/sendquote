    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-400 mt-3">Loading clients...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          ...
          {sortedClients.length === 0 ? (
            <EmptyState
              ...
              description={search ? "Try a different search term" : "Create quotes to see your clients here"}
              action={!search ? { label: "Create a Quote", href: "/quote/new" } : undefined}
            />
          ) : (
