        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          ...
          {filtered.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-sm text-slate-400 mt-1">Accept a quote to create your first invoice</p>
              <Link href="/dashboard" className="mt-4 inline-block text-sm text-indigo-600 hover:text-indigo-700">
                View quotes →
              </Link>
            </div>
          ) : (
