  ...
  return (
    <section className="relative overflow-hidden px-4 pt-24 pb-20 sm:pt-28 sm:pb-24 lg:pt-32 lg:pb-28">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-muted/10 blur-[150px]" />
      </div>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.95]">
              ...
              <br />
              <span className="text-foreground/30">Not in Weeks</span>
            </h1>
          </m.div>
          ...
          >
            ...
            <br />
            <span className="text-foreground/80 font-medium">From conversation to contract — in hours, not days.</span>
          </m.p>
          ...
          >
            <Link
              href="/signup"
              className="group inline-flex h-12 items-center justify-center rounded-xl bg-primary px-7 text-sm font-semibold text-primary-foreground hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300"
            >
            ...
            <Link
              href="/pricing"
              className="inline-flex h-12 items-center justify-center rounded-xl border border-border bg-muted/20 px-7 text-sm font-medium text-muted-foreground hover:bg-white/[0.06] hover:text-white transition-all"
            >
              See Pricing
            </Link>
          </m.div>
        ...
        >
          {stats.map((stat, i) => (
            <m.div
              ...
              className="rounded-xl border border-border bg-muted/20 p-5 text-center hover:bg-white/[0.04] hover:border-primary/10 transition-colors duration-300"
            >
        ...
        <div className="absolute bottom-1/4 left-1/4 w-4 h-4 border border-border rounded-lg rotate-45 motion-safe:animate-pulse" style={{ animationDuration: "5s" }} />
      </div>
    </section>
  );
}
