-- Transactional Quote Creation RPC
-- Creates a quote and its items in a single atomic operation
...
BEGIN
  INSERT INTO quotes (
    ...
    client_phone, client_address, valid_till, payment_terms, subtotal,
    ...
    p_client_phone, p_client_address, p_valid_till, p_payment_terms, p_subtotal,
